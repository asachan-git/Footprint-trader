...
input string InpBridgeURL   = "http://127.0.0.1:5001"; // Branch 1 bridge URL (whitelist host!)
input int    InpMagic       = 771000;                  // Branch 1 magic BASE (server FB_MAGIC_BASE must match)
