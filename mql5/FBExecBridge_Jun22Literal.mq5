...
#property strict
// FBExecBridge_Jun22Literal — pre-set for feat/jun22-literal, port 5005, magic base 775000.
// Single-branch config (URL2/3 left blank); attach directly, no input editing needed.
// This EA binary is unchanged from FBExecBridge_Final (v1.10) — the jun22-literal SERVER
// only emits a SUBSET of what this EA already handles (PLACE_PENDING/CLOSE_ALL/CANCEL_
// PENDINGS/CLOSE_SIDE/MOVE_BE — literal Jun22's full command set), so the current compiled
// EA is fully compatible without recompiling against Jun22-era MQL5 source.
// Magic base 775000 is distinct from every other branch (crude 770000, jul06 771000,
// jul09 772000, jun22exact 773000, final-v1 774000).
// Server must be launched with FB_MAGIC_BASE=775000 on port 5005 to match.

#include <Trade\Trade.mqh>
#include <Trade\OrderInfo.mqh>
#include <Trade\PositionInfo.mqh>

input string InpBridgeURL   = "http://127.0.0.1:5005"; // Branch 1 bridge URL (whitelist host!)
input int    InpMagic       = 775000;                  // Branch 1 magic BASE (server FB_MAGIC_BASE must match)
